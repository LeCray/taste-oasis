        ...
        <div className="glass-card rounded-lg p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-2xl font-bold text-coral">12:45 PM</p>
            </div>
            <Clock className="h-12 w-12 text-coral" />
          </div>
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="w-1 bg-coral rounded relative">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 bg-coral rounded-full" />
              </div>
            ...
            <div className="flex gap-4">
              <div className="w-1 bg-muted rounded relative">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 border-2 border-coral rounded-full bg-background" />
              </div>
              <div className="flex-1 pb-4">
          ...
          <div className="space-y-3">
            ...
            <div className="pt-3 border-t mt-3">
              <div className="flex justify-between items-center font-semibold">
                <span>Total</span>
                <span className="text-coral">$38.97</span>
              </div>
            </div>
          </div>
        </div>
